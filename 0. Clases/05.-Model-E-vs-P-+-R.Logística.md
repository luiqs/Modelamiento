...
|     | (Intercept) |       carb |       cyl |        wt |       am |       qsec |         hp | family             |  df |    logLik |     AICc |     delta |       weight |
|-----|------------:|-----------:|----------:|----------:|---------:|-----------:|-----------:|:-------------------|----:|----------:|---------:|----------:|-------------:|
| 3   |    9.617781 |         NA |        NA | -3.916504 | 2.935837 |  1.2258860 |         NA | gaussian(identity) |   5 | -72.05969 | 156.4271 |  0.000000 | 0.4587701172 |
| 2   |   39.686262 |         NA | -1.507795 | -3.190972 |       NA |         NA |         NA | gaussian(identity) |   4 | -74.00503 | 157.4915 |  1.064483 | 0.2694297161 |
| 4   |   39.602140 | -0.4857629 | -1.289788 | -3.159452 |       NA |         NA |         NA | gaussian(identity) |   5 | -72.80873 | 157.9252 |  1.498091 | 0.2169145862 |
| 5   |   20.037880 | -0.5221880 | -0.461198 | -3.046227 | 2.941727 |  0.7272474 |         NA | gaussian(identity) |   7 | -71.03086 | 160.7284 |  4.301328 | 0.0534039806 |
| 6   |   33.966671 | -0.7975317 | -1.274007 |        NA | 4.186544 | -0.1288322 | -0.0214835 | gaussian(identity) |   7 | -74.84548 | 168.3576 | 11.930556 | 0.0011773562 |
| 1   |   37.812739 | -0.5261460 | -2.625023 |        NA |       NA |         NA |         NA | gaussian(identity) |   4 | -80.79127 | 171.0640 | 14.636951 | 0.0003042437 |
...
Debemos definir los siguientes terminos:

-   Verdadero positivo (VP): predice correctamente casos positivos (1)

-   Falso positivo (FP): predice como negativo (0) , casos positivos (1)

-   Verdadero negativo (VN): predice correctamente casos negativos (0)

-   Falso negativo (FN): Predico como positivo (1), casos negativos (0)

Es deseado realizar una predicción que maximicen los valores de VP y VN.
De esta manera:

-   Precision mide que tan bueno es nuestro modelo para realizar una
    predición positiva (ratio = VP / (VP + FP).

-   Recall mide que tan bueno es nuestro modelo para realizar una
    predicción negativa (ratio = VN / (VN + FN).

Incrementar “Precision” repercute en la disminución de “Recall” y
viceversa (hay siempre un intercambio entre ellos).

Al valor de verdadero positivo (VP) también se le conoce como

#### B.5.3 Sentitivity y Specificity

Estos dos terminos son muy similares a Precision y Recall, pero no
iguales. Son usados en la generación de curvas ROC y evaluaciones AUC.
Se definen matemáticamente de la siguiente manera:

-   Sensititity: Verdadero positivo / (Verdadero positivo + Falso
    Negativo)

-   (1-Specificity): Falso positivo / (Falso positivo + Verdadero
    Negativo)
...
![](05.-Model-E-vs-P-+-R.Logística_files/figure-gfm/unnamed-chunk-25-1.png)<!-- -->
...
![](05.-Model-E-vs-P-+-R.Logística_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
-   Libro:
    <http://idaejin.github.io/courses/R/2019/euskaltel/index.html>
