...
**Altitud**. **Nota:**: Realice el análisis de todos los coeficientes de
la regresión aprendidos en clase (compruebe si existe o no relación,
entre otros) y el análisis de residuos respectivo. Evalue el modelo de
acuerdo a las técnicas y gráficos aprendidos. No se olvide de discutir
